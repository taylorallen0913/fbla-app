  ...
  addAttendance = () => {
    ...
    firebase
      ...
      .then(doc => {
        ...
        activeMeetingData.attendance.push(
        ...
        firebase
          ...
          .collection("chapters")
          .doc(this.state.id)
          .update({ activeMeeting: activeMeetingData });
      });
  };
      ...
      .then(doc => {
        ...
        if (
          !(
            ...
            activeData.constructor === Object
          ) &&
          this.state.inputId == activeData.id
        ) {
          firebase
            .firestore()
            .collection("chapters")
            ...
            .then(doc => {
              ...
              let inRange = this.isInRange(5, lat1, long1, lat2, long2);
              if (inRange) {
                this.addAttendance();
                this.setState(
                  { successMessage: "Success: Attendance was marked" },
              ...
              if (!inRange) {
                this.setState(
                  {
                    errorMessage: "Error: You are not in range of the meeting"
                  },
          ...
          this.setState(
            {
              errorMessage:
                "Error: Meeting is not currently in session or code is invalid"
            },
            () => this.setState({ successMessage: null })
          );
        }
