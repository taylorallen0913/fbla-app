...
function createCompatNavigatorFactory(createNavigator) {
  ...
  const createCompatNavigator = function createCompatNavigator(routeConfig) {
    let navigationConfig = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    ...
    function Navigator(_ref) {
      ...
      const screens = React.useMemo(() => routeNames.map(name => {
        ...
        return React.createElement(Pair.Screen, {
          ...
          return React.createElement(_CompatScreen.default, {
      ...
      return React.createElement(_ScreenPropsContext.default.Provider, {
        value: screenProps
